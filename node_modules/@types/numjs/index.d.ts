...
export interface NdArray<T = number> extends BaseNdArray<T> {
	...
	/**
	 * Calculate the log10 of all elements in the array, element-wise.
	 *
	 * @param [copy=true] - set to false to modify the array rather than create a new one
	 */
...
/**
 * Calculate the log10 of all elements in the input array, element-wise.
 *
 */
export function log<T = number>(x: NjParam<T>): NdArray<T>;
